...
```{r , message=TRUE, eval=FALSE, cache=TRUE, error=FALSE}
...
logit2prob <- function(logit){
 ...
 for(i in 1:nrow(all_preds)){
   ...
   # In the following, we apply isotonic regression to the predicted survival probabilities using isoreq() function. 
